...
#include "../../linkKarel_3little/workerthread.h"
...
QT_MOC_LITERAL(1, 13, 14), // "triggerSendMsg"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "WorkerThread\0triggerSendMsg\0"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->triggerSendMsg(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::triggerSendMsg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkerThread::triggerSendMsg()
{
